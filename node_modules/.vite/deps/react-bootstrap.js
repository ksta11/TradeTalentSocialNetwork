...
function useRTGTransitionProps(_ref) {
  ...
  const childRef = major >= 19 ? children.props.ref : children.ref;
  const nodeRef = (0, import_react45.useRef)(null);
  ...
  const handleEnter = (0, import_react45.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react45.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react45.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react45.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react45.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react45.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react45.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react45.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React64.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime58.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime59.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
...
var Modal = (0, import_react47.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime60.jsx)(import_jsx_runtime60.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime60.jsxs)(import_jsx_runtime60.Fragment, {
...
var AbstractModalHeader = React71.forwardRef(({
  ...
  const context6 = (0, import_react48.useContext)(ModalContext_default);
...
var Modal2 = React74.forwardRef(({
  ...
  const renderBackdrop = (0, import_react49.useCallback)((backdropProps) => (0, import_jsx_runtime68.jsx)("div", {
    ...backdropProps,
...
var NavItem = React75.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React76.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames54.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav = React77.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
...
var NavbarCollapse = React79.forwardRef(({
  ...
  return (0, import_jsx_runtime73.jsx)(Collapse_default, {
...
var NavbarToggle = React80.forwardRef(({
  ...
  return (0, import_jsx_runtime74.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames57.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime74.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react53.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react54.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasToggling = React82.forwardRef(({
  ...
  return (0, import_jsx_runtime76.jsx)(TransitionWrapper_default, {
    ...
    children: (status, innerProps) => React82.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames59.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var Offcanvas = React85.forwardRef(({
  ...
  const renderBackdrop = (0, import_react55.useCallback)((backdropProps) => (0, import_jsx_runtime79.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames62.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime79.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames62.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  ...
  return (0, import_jsx_runtime84.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime84.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime84.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames64.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
var NavDropdown = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames65.default)(className, navItemPrefix),
...
var Popover = React94.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsxs)("div", {
    ...
    className: (0, import_classnames68.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
  ...
  return (0, import_jsx_runtime93.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React96.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames70.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime95.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react62.cloneElement)(children, triggerProps), (0, import_jsx_runtime94.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React98.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsx)("li", {
    ref,
    style: style2,
    className: (0, import_classnames71.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime98.jsxs)(Component2, {
      className: (0, import_classnames71.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
var Pagination = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames72.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames73.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime102.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames74.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var Ratio = React103.forwardRef(({
  ...
  return (0, import_jsx_runtime103.jsx)("div", {
    ...
    className: (0, import_classnames75.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React104.forwardRef(({
  ...
  return (0, import_jsx_runtime104.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames76.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime115.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
...
var ToastFade = React115.forwardRef((props, ref) => (0, import_jsx_runtime117.jsx)(Fade_default, {
  ...props,
  ref,

...
import {
  ...
  TabContext_default,
  useNavItem
} from "./chunk-RXSMZ66Q.js";
import {
  DropdownButton_default
} from "./chunk-CE44CYWJ.js";
import {
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-LA6OTNUX.js";
import {
  require_warning
} from "./chunk-I2B5HEAR.js";
import "./chunk-TDQDCMKX.js";
import {
  DEFAULT_BREAKPOINTS,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime43.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime43.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime43.jsx)(InputGroupText_default, {
  children: (0, import_jsx_runtime43.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React46.forwardRef(({
  ...
  return (0, import_jsx_runtime43.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react18.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react19.useRef)(inProp);
  ...
  const child = (0, import_react19.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react20.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React47.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose3(_ref, _excluded2);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime44.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react21.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime45.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime45.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime45.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react22.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime46.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime46.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime46.jsx)(import_jsx_runtime46.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime46.jsxs)(import_jsx_runtime46.Fragment, {
...
var ModalBody = React50.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React51.createContext({
...
var AbstractModalHeader = React54.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context4 = (0, import_react23.useContext)(ModalContext_default);
...
var Modal2 = React57.forwardRef(({
  ...
  const renderBackdrop = (0, import_react24.useCallback)((backdropProps) => (0, import_jsx_runtime54.jsx)("div", {
    ...backdropProps,
...
var NavItem = React58.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React59.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav = React60.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react25.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react25.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarBrand = React61.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React62.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React63.forwardRef(({
  bsPrefix,
  className,
  children,
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react28.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react29.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React64.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasTitle = React67.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React68.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const modalManager = (0, import_react30.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react30.useState)(false);
  const handleHide = useEventCallback(onHide);
  ...
  const renderBackdrop = (0, import_react30.useCallback)((backdropProps) => (0, import_jsx_runtime65.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React69.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context4 = (0, import_react31.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
...
var NavbarText = React70.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React71.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react32.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react32.useMemo)(() => ({
...
var NavDropdown = React72.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime72.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames58.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime71.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime71.jsx)(Dropdown_default.Menu, {
      role: menuRole,
...
var PopoverHeader = React74.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React75.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Tooltip = React78.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Overlay2 = React79.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime79.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React79.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React80.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime82.jsxs)(import_jsx_runtime81.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react37.cloneElement)(children, triggerProps), (0, import_jsx_runtime80.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React81.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React81.forwardRef(({
    children,
    ...props
...
var Pagination = React82.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime85.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames65.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames66.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React83.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime86.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React84.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React85.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React86.forwardRef(({
  ...
  return (0, import_jsx_runtime89.jsx)("div", {
    ...
    children: React86.Children.only(children)
  });
});
...
var SplitButton = React89.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime93.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime92.jsx)(Button_default, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime92.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime92.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var ToastFade = React98.forwardRef((props, ref) => (0, import_jsx_runtime103.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToggleButton = React104.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsxs)(import_jsx_runtime110.Fragment, {
    children: [(0, import_jsx_runtime109.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime109.jsx)(Button_default, {
      ...props,
      ref,
